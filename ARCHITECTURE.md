...
| `apps/agent-orchestrator` | Agent orchestration engine: authorizes which named agent (Emma + specialists) may handle a task type before it is queued for execution - real as of ADR-0017                 | 4002         |
